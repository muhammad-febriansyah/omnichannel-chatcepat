// Package official reserves the stable boundary for Meta's official API.
package official
...
func (a *Adapter) Name() string                                         { return "instagram_official" }
...
func (a *Adapter) HealthCheck(context.Context, channel.Connection) (*channel.Health, error) {
	return &channel.Health{Status: "disconnected", Message: "Official Meta adapter placeholder"}, channel.ErrPermanent
}
