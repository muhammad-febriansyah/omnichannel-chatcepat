        ...
        <div className="relative mt-14 grid gap-8 md:grid-cols-3">
          ...
          {STEPS.map((s, i) => (
            <Reveal key={s.title} delay={i * 0.1} className="relative text-center">
              <div className="mx-auto inline-flex size-14 items-center justify-center rounded-2xl border border-border bg-background text-brand-blue shadow-sm dark:text-brand-light">
                {s.icon}
              </div>
